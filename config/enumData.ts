       ...
       Blog: {
        ...
        children: [
          ...
          },
          {
            ...
            View: { name: 'Xem', code: 'BlogType_View', value: false },
            Create: {name: "Thêm mới", code: "BlogType_Create", value: false},
            Detail: { name: 'Xem chi tiết', code: 'BlogType_Detail', value: false },
            Edit: { name: 'Chỉnh Sửa', code: 'BlogType_Edit', value: false },
            Delete: { name: 'Xóa', code: 'BlogType_Delete', value: false },
          },
          {
            code: 'BlogComment',
