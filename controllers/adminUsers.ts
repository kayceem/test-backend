...
exports.createRandomUser = async (req: Request, res: Response, next: NextFunction) => {
  try {
    let result = [];
    ...
    if(!error) {
      const error = new CustomErrorMessage("Failed to get random users!", 500);
...
exports.postUser = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    if (!error) {
      const error = new CustomErrorMessage("Failed to fetch categories!", 500);
      return error;
    }
    next(error);
  }
...
exports.updateUser = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    if (!error) {
      const error = new CustomErrorMessage("Failed to update user!", 422);
      return error;
    }
    next(error);
  }
