...
export const backendCourses = [
  ...
  "Scalability and Performance in Backend Development",
  "API Development and Integration",
  "Security in Backend Development",
  "Advanced Server-Side Scripting",
  "Backend Frameworks and Best Practices",
  "Building Microservices with Backend Development",
...
export const blockchainCourses = [
  ...
  "Governance and Consensus Mechanisms in Blockchain",
...
export const mobileCourses = [
  ...
  "Mobile Backend Development and APIs",
...
export const gameCourses = [
  ...
  "3D Game Development with Unreal Engine",
  "Mobile Game Development",
  "Game Physics and Simulation",
  "Game AI and Behavior Programming",
...
export const courseDescriptions = [
  ...
  "Learn how to use Python for data analysis, machine learning, and artificial intelligence.",
  "Become a full-stack web developer by learning the popular MERN stack: MongoDB, Express, React, and Node.js.",
  "Discover the world of containerization and orchestration with Docker and Kubernetes.",
  "Prepare for the AWS Certified Solutions Architect - Associate exam and become a cloud expert.",
